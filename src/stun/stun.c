...
static const char SOFTWARE[] = "salty-stun " SALTY_STUN_VERSION " (" SALTY_STUN_SOURCE_URL ")";
...
static void fill_software(struct context *ctx) {
    ...
    struct stun_attr *attr = packet_set_len(&ctx->response, sizeof(*attr) + software_len);
